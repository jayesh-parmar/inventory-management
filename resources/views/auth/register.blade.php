<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div>
            <x-input-label for="mobile_name" :value="__('Mobile Number')" />
            <x-text-input id="mobile_name" class="block mt-1 w-full" type="text" name="mobile_number" :value="old('mobile_number')" required autofocus autocomplete="mobile_number" />
