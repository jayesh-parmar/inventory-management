@include('admin.layouts.main')
            <br><br>
            <div class="heading text-center  font-bold text-2xl m-5 text-white-800 m-4 title bg-gray-100 border border-gray-300 p-2 mb-4 outline-none">New Colors Add</div>
            <style>
                body {
            ...
            <form action="{{route('store-color')}}" method="post" class="mt-5">
              @csrf
