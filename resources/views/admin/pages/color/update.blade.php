@include('admin.layouts.main')
        ...
        <form action="{{route('update-color',$data->id)}}" method="post">
            @csrf
            <div class="editor mx-auto w-10/12 flex flex-col text-gray-800 border border-gray-300 p-4 shadow-lg max-w-2xl">
                ...
                <div class="buttons flex">
                    <div class=" btn border border-gray-300 p-1 px-4 font-semibold cursor-pointer text-gray-500 ml-auto"><a href="{{route('color')}}">Cancel</a></div>
                    <button>
