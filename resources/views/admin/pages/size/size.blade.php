@include('admin.layouts.main')
        <div class="heading text-center  font-bold text-2xl m-5 mt-4 text-white-800 m-4 title bg-gray-100 border border-gray-300 p-2 mb-4 outline-none">New Sizes Add</div>
        <style>
            body {
